...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            ...
            <li><span>Image 02</span><div><h3>Parking</h3></div></li>
            <li><span>Image 03</span><div><h3>Lobby</h3></div></li>
            <li><span>Image 04</span><div><h3>Specialists</h3></div></li>
            <li><span>Image 05</span><div><h3>Exam Rooms</h3></div></li>
            <li><span>Image 06</span><div><h3>24 hour care</h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>Eastern Animal Hospital</span></h1>
